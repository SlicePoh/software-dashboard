const styles = {
    ...
    side: "float-right bottom-0 top-16 right-0 fixed bg-gray-100 h-screen w-3/12",
  ...
  export const layout = {
    ...
    menu: `${styles.flexBetween} flex-col float-left bottom-0 left-0 fixed w-1/9 text-slate-400 `,
